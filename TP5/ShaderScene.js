class ShaderScene extends CGFscene {
	...
	init(application) {
		...
		this.testShaders = [
			...
			new CGFshader(this.gl, "shaders/screenColourSplit.vert", "shaders/screenColourSplit.frag"),
			new CGFshader(this.gl, "shaders/sinTranslation.vert", "shaders/sinTranslation.frag"),
