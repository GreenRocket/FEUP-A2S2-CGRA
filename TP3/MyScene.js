...
class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.normalCube = new MyNormalCube(this, 10);
        this.tangram = new MyTangram(this);
        
        this.objects = [this.plane, this.pyramid, this.cone, this.unitCube, this.normalCube, this.tangram];

        // Labels and ID's for object selection on MyInterface
        this.objectIDs = { 'Plane': 0 , 'Pyramid': 1, 'Cone': 2, 'Unit Cube' : 3, 'Normal Cube' : 4, 'Tangram' : 5 };
    ...
    initMaterials() {
        ...
        // Wood material
        var woodColour = this.hexToRgbA("#592e07");

        this.material4 = new CGFappearance(this);
        this.material4.setAmbient(0.0, 0.0, 0.0, 1.0);
        this.material4.setDiffuse(woodColour[0], woodColour[1], woodColour[2], 1.0);
