...
class MyTangram extends CGFobject {
	...
	initObjects() {
        ...
        this.leftSmallTriangle = new MySmallTriangle(this.scene);
        this.rightSmallTriangle = new MySmallTriangle(this.scene);
        this.leftBigTriangle = new MySmallTriangle(this.scene);
        this.rightBigTriangle = new MySmallTriangle(this.scene);
    ...
    initMaterials(){
        ...
        // this.triangleMat.setAmbient(0.0, 0.0, 0.0, 1.0);
        // this.triangleMat.setDiffuse(1,0.608,0.812);
        // this.triangleMat.setSpecular(0.8, 0.8, 0.8, 1.0);
        // this.triangleMat.setShininess(10.0);

        // this.leftSmallTriangle = new CGFappearance(this.scene);
        // this.leftSmallTriangle.setAmbient(0.0, 0.0, 0.0, 1.0);
        // this.leftSmallTriangle.setDiffuse(0.588, 0.314, 0.745, 1.0);
        // this.leftSmallTriangle.setSpecular(0.8, 0.8, 0.8, 1.0);
        // this.leftSmallTriangle.setShininess(10.0);

        // this.diamondMat = new CGFappearance(this.scene);
        // this.diamondMat.setAmbient(0.0, 0.0, 0.0, 1.0);
        // this.diamondMat.setDiffuse(0, 1, 0, 1.0);
        // this.diamondMat.setSpecular(0.8, 0.8, 0.8, 1.0);
        // this.diamondMat.setShininess(10.0);

        // this.parallelogramMat = new CGFappearance(this.scene);
        // this.parallelogramMat.setAmbient(0.0, 0.0, 0.0, 1.0);
        // this.parallelogramMat.setDiffuse(1, 1, 0, 1.0);
        // this.parallelogramMat.setSpecular(0.8, 0.8, 0.8, 1.0);
